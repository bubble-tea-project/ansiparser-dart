...
void main() {
  test('example_1', () {
    ...
    ansipScreen.put(data);
    ansipScreen.parse();

    final resultStr = ansipScreen.toFormattedString();
    expect(resultStr.toString(), equals(answerStr.toString()));

    final resultHtml = ansipScreen.toHtml();
    expect(resultHtml.toString(), equals(answerHtml.toString()));
  });

  test('example_2', () {
    final data = "[31mRED[0m [32mGREEN[0m [34mBLUE[0m";
    final answer = [
    ...
    final result = ansipScreen.toHtml();

    expect(result.toString(), equals(answer.toString()));
  });

  test('example_3', () {
    final data = """[1;34mHello   [1;3H[47mW    
